...
export const Meta: React.FC<{meta: {title: string; link?: string; desc?: string; image?: string}}> = (props) => {
  const { meta } = props;
  return (
    <NextHead>
      <title>{meta.title}</title>
      <meta name="copyright" content="Gregoire Cousin" />
      ...
      {meta.desc && ( <meta name="og:description" property="og:description" content={meta.desc} /> )}
